...
def preprocess_dataset_text(
    ...
    if scope == "track":
        return [
            _encode_label_set(
                labels=ensure_silence_label(_track_labels(track, namespace, annotation_processing)),
    ...
    for dataset, labels in sorted(labels_by_dataset.items()):
        labels = ensure_silence_label(_unique_in_order(labels))
        results.append(
            _encode_label_set(
                labels=labels,
                dataset=dataset,
...
MUSIC_STRUCTURE_DESCRIPTIONS = {
    ...
    "breakdown": "a reduced or contrasting section where the groove, texture, or energy changes.",
    "bridge": "a contrasting transitional section between other sections.",
    "build up": "a section that increases energy or tension before a later section.",
    ...
    "interlude chorus": "a chorus-like interlude or short refrain passage between larger sections.",
    ...
    "rap": "a rap vocal section, often functioning like a verse or featured passage.",
    "rhythmless intro": "an opening section before the main rhythmic groove begins.",
    "generic section": "a numbered or otherwise unspecified structural section.",
    "silence": "a silent or near-silent region.",
    "slow section": "a slower or reduced-energy section.",
    ...
    "stutter section": "a section using repeated or chopped rhythmic material.",
    "synthesizer": "a section featuring synthesizer material.",
