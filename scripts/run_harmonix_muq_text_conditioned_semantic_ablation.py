...
LABEL_SETUPS: dict[str, dict[str, Any]] = {
    ...
    "corpus_ids": {
        "text_embedding_root": "data/embeddings/text_harmonix_base_section_ids_corpus_muq_mulan",
    ...
    "ordered": {
        "text_embedding_root": "data/embeddings/text_harmonix_base_section_ids_ordered_muq_mulan",
        "annotation_processing": {
    ...
    "shuffled": {
        "text_embedding_root": "data/embeddings/text_harmonix_base_section_ids_shuffled_muq_mulan",
        "annotation_processing": {
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run Harmonix semantic/anonymized-label ablations with the simple "
            "text-conditioned CE model and MuQ-MuLan text embeddings."
        )
    )
    parser.add_argument(
        "--output-dir",
        default="outputs/benchmarks/harmonix_muq_text_conditioned_ce_semantic_ablation",
    )
